...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		.description("API do Projeto de Blog Pessoal em spring")
		.version("1.0.0")
		.license("Apache License Version 2.0")
		.licenseUrl("https://github.com/devnivek/turma27java/tree/main/spring/blogPessoal")
		.contact(contact())
		.build();
	...
	private static Contact contact() {
		...
		return new Contact("Kevin Santos",
		"https://github.com/devnivek",
		"kevin.santos@outlook.com");
